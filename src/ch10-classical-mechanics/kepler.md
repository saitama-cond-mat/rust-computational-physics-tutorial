...
[第4章](../ch04-multidimensional-data/ndarray.md)で導入した`ndarray`クレートを使用して、速度ベレ法を実装します。
...
一方、[第9章](../ch07-ode/euler.md)で学んだオイラー法を用いた場合、エネルギーは指数関数的に増大し、惑星は螺旋を描いて太陽から遠ざかってしまいます。
